...
const About: React.FC = () => {
  ...
  return (
    <div className="relative">
      <img src="assets/orange-ball.png" alt="ball" className="h-[3rem] w-[3rem] absolute top-[35rem] left-[-1rem] md:z-20 animate-floating" />
      <img src="assets/orange-ball.png" alt="ball" className="h-[4rem] w-[4rem] absolute top-[-3rem] left-[15rem] z-20 md:z-0" />
      ...
      <img
        ...
        alt="ball"
        className="h-[5rem] w-[5rem] absolute top-[5rem] right-[-1rem] md:top-[5rem] md:right-[-4rem] z-20 "
      />
      ...
      <div className="flex flex-col gap-4 bg-stone-700/20 backdrop-blur rounded-xl relative mt-36 mb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 py-20 px-4 md:px-8 gap-8">
        ...
        <div className="p-4 flex items-center justify-center flex-col mb-12 md:mb-24 gap-4">
        ...
        {true ? (
          <div className="absolute text-stone-100/80 bottom-[-2rem] md:bottom-[-4rem] bg-gradient-to-tr from-ss-orange-500 to-orange-500 flex gap-4md:gap-12 px-4 gap-4 md:px-12 py-4 md:py-8 rounded-lg left-0 right-0 mx-auto max-w-fit">
            <div className="flex flex-col items-center justify-center">
              <h3 className="text-xl md:text-4xl">7</h3>
              <p className="uppercase font-extrabold text-xs md:text-sm">winners</p>
            </div>
            <div className="flex flex-col items-center justify-center">
              <h3 className="text-xl md:text-4xl">
                {90} {denom.slice(1)}
              </h3>
              <p className="uppercase font-extrabold text-xs md:text-sm">Payouts to winners</p>
            </div>
            <div className="flex flex-col items-center justify-center">
              <h3 className="text-xl md:text-4xl">35</h3>
              <p className="uppercase font-extrabold text-xs md:text-sm">Tickets sold</p>
            </div>
          </div>
        ) : (
          <Spinner />
