...
import Pluton from "../../components/Icons/Pluton";
import Saturn from "../../components/Icons/Saturn";
import Uranus from "../../components/Icons/Uranus";
import Venus from "../../components/Icons/Venus";

const About: React.FC = () => {
  return (
    <div className="relative">
      <Mercury className="h-[3rem] w-[3rem] absolute top-[35rem] left-[-1rem] z-20 animate-floating" />
      <Venus className="h-[5rem] w-[5rem] absolute top-[-4rem] left-[15rem]" />
      <Earth className="h-[6rem] w-[6rem] absolute bottom-[5rem] left-[4rem] animate-floating" />
      <Mars className="h-[5rem] w-[5rem] absolute top-[5rem] right-[-4rem] " />
      <Jupiter className="h-[9rem] w-[9rem] absolute top-[-6rem] right-[-2rem] animate-floating" />
      <Saturn className="h-[8rem] w-[8rem] absolute top-[-5rem] z-20 animate-floating" />
      <Uranus className="h-[7rem] w-[5rem] absolute bottom-[7rem] right-[-2rem] z-20 animate-floating" />
      <Neptune className="h-[5rem] w-[5rem] absolute bottom-[18rem] left-[-4rem] " />
      <Pluton className="h-[3rem] w-[3rem] absolute bottom-[5rem] right-[5rem] animate-floating" />
      <div className="flex flex-col gap-4 bg-stone-700/20 backdrop-blur rounded-xl relative my-36">
        ...
        <div className="absolute text-stone-800 bottom-[-4rem] bg-gradient-to-tr from-ss-orange-500 to-orange-500 flex gap-12 px-12 py-8 rounded-lg left-0 right-0 mx-auto max-w-fit">
